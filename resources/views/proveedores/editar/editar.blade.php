<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            ...
            {{ __('Actualizar proveedor #' . $proveedor->idProveedor) }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- * enlace para regresa a la vista proveedores --}}
            ...
            {{-- * formulario para agregar nuevo proveedor, action: ____ruta donde va a ir los datos de este formulario____ concatenando el id del proveedor  --}}
            <form class="max-w-md mx-auto" action="{{ route('actualizarproveedor', $proveedor->idProveedor) }}"
                method="POST">
                @csrf
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" name="razon_social" id="razon_social" maxlength="255"
                        {{-- * en este campo ponemos el valor del proveedor que recuperamos correspondiente  --}}
                        value="{{ $proveedor->razonSocial }}"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                    <label for="razon_social"
                        class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Razón
                        social</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="tel" name="telefono" id="telefono" min="0"
                            {{-- * en este campo ponemos el valor del proveedor que recuperamos correspondiente  --}}
                ...
                <div class="flex">
                    {{-- * enlace para regresar a la vista proveedores --}}
                    <a href="{{ route('proveedores') }}"
        ...
        {{-- !fin ormulario para actualizar proveedor --}}
