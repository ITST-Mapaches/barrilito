<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form class="max-w-md mx-auto" action="{{ route('insertproducto') }}" method="POST">
                @csrf
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        ...
                        <input datepicker datepicker-autohide type="text" name="expiracion" id="expiracion"
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-5 group">
                        ...
                        <div class="relative flex items-center max-w-[8rem]">
                            ...
                            <input type="text" id="stock" name="stock" data-input-counter  data-input-counter-min="1"
                ...
                <div class="flex">
                    ...
                    <button type="submit"
                        class="block mx-auto active:scale-90 text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Agregar</button>
                </div>
